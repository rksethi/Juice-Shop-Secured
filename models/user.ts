    ...
    { // vuln-code-snippet hide-start
      ...
      password: {
        ...
        set (clearTextPassword: string) {
          // SECURITY FIX: Use bcrypt for new passwords, but keep MD5 for backward compatibility
          // In production, migrate all passwords to bcrypt
          // For now, we'll hash with MD5 for compatibility, but login will verify using both methods
